...
feature_extractor.load_state_dict(torch.load('checkpoints/houston/feature_extractor.pth'))
classifier.load_state_dict(torch.load('checkpoints/houston/classifier.pth'))
...
classification_map(hsi_pic[:, :, :], 24,
                   "classification_map/houston_map.png")
