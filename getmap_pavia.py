...
feature_extractor.load_state_dict(torch.load('checkpoints/pavia/feature_extractor.pth'))
classifier.load_state_dict(torch.load('checkpoints/pavia/classifier.pth'))
...
classification_map(hsi_pic[:, :, :], 24,
                   "classification_map/pavia_map.png")
